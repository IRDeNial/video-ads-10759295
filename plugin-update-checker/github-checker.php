...
class PucGitHubChecker_3_1 extends PluginUpdateChecker_3_1 {
	...
	public function requestInfo($unusedQueryArgs = array()) {
		...
		//Try parsing README.md. If it's formatted according to WordPress.org standards, it will contain
	...
	/**
	 * Copy plugin metadata from the remote README.md file.
	 *
	 * @param string $ref GitHub tag or branch where to look for the readme.
	 * @param PluginInfo_3_1 $pluginInfo
	 */
	protected function setInfoFromRemoteReadme($ref, $pluginInfo) {
		$readmeTxt = $this->getRemoteFile('README.md', $ref);
		if ( empty($readmeTxt) ) {
			return;
		}
	...
	/**
	 * Check if the currently installed version has a README.md file.
	 *
	 * @return bool
	 */
	protected function readmeTxtExistsLocally() {
		...
		return is_file($pluginDirectory . '/README.md');
	}
